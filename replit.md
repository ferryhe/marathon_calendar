...
- 香港賽事手工種子（`script/seed-hk-marathons.ts`）：以 `hk-{slug}-{year}` 為 canonical_name，country='China'，dev + prod 各匯入 3 場（Standard Chartered HK Marathon 2026、HKZMB Half Marathon 2026、HKIA 3RS 10km 2026）。日期待公佈者 race_date=NULL，狀態 upcoming。
